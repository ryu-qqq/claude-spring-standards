 ...
 * {@link RepositoryTestSupport}를 사용하세요.
 *
 * <h2>Slice 테스트 특징:</h2>
 * <ul>
 *   <li>JPA 관련 Bean만 로드 (Service, Controller 제외)</li>
 *   <li>빠른 실행 속도</li>
 *   <li>H2 기본 사용 (MySQL 호환 모드)</li>
 * </ul>
 *
 * <h2>사용 예시:</h2>
 * <pre>{@code
...
public abstract class JpaSliceTestSupport {
     ...
     *
     * <p>테스트에서 엔티티 영속화 및 조회에 사용합니다.
     * 일반 EntityManager보다 테스트에 편리한 메서드를 제공합니다.
     */
    @Autowired
