...
class JpaRepositoryArchTest {
    ...
    static void setUp() {
        ...
        // JpaRepository 인터페이스만 (QueryDsl, Admin, Lock, Jdbc, ZeroTolerance 제외)
        jpaRepositoryClasses =
                allClasses.that(
                        DescribedPredicate.describe(
                                "JPA Repository 인터페이스 (*Repository,"
                                        + " QueryDsl/Admin/Lock/Jdbc/ZeroTolerance 제외)",
                                javaClass ->
        ...
        void jpaRepository_MustNotHaveQueryMethods() {
            ...
            ArchRule rule =
                    noMethods()
                            ...
                            .and()
                            .areDeclaredInClassesThat()
                            .haveSimpleNameNotContaining("ZeroTolerance")
                            .and()
                            .areDeclaredInClassesThat()
                            .areInterfaces()
                            .and()
