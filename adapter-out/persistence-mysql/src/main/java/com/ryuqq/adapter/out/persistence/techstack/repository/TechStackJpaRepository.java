...
/**
 * TechStackJpaRepository - TechStack JPA Repository
 *
 * <p>TechStack 엔티티의 기본 CRUD를 제공합니다.
 *
 * <p><strong>주의사항:</strong>
 *
 * <ul>
 *   <li>Command 작업 전용입니다 (save, delete 등)
 *   <li>Query 작업은 TechStackQueryDslRepository를 사용합니다
...
public interface TechStackJpaRepository extends JpaRepository<TechStackJpaEntity, Long> {
    ...
    // Query 작업은 TechStackQueryDslRepository에서 처리
}
