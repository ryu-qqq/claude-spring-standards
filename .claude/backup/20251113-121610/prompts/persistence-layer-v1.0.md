...
- [JPA Entity 설계](../../docs/coding_convention/04-persistence-layer/legacy/jpa-entity-design/)
- [QueryDSL 최적화](../../docs/coding_convention/04-persistence-layer/legacy/querydsl-optimization/)
