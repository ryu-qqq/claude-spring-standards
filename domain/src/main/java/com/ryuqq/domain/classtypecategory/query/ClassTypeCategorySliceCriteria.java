package com.ryuqq.domain.classtypecategory.query;
...
/**
 * ClassTypeCategorySliceCriteria - ClassTypeCategory 슬라이스 조회 조건 (커서 기반)
 *
 * <p>ClassTypeCategory 목록 조회 시 사용되는 커서 기반 페이징 조건입니다.
 *
 ...
 * @since 1.0.0
 */
public record ClassTypeCategorySliceCriteria(
    ...
    public ClassTypeCategorySliceCriteria {
     ...
     */
    public static ClassTypeCategorySliceCriteria first(int size) {
        return new ClassTypeCategorySliceCriteria(
     ...
     * @return ClassTypeCategorySliceCriteria
     */
    public static ClassTypeCategorySliceCriteria firstByArchitecture(
            ArchitectureId architectureId, int size) {
        return new ClassTypeCategorySliceCriteria(
                null, List.of(architectureId), null, null, CursorPageRequest.first(size));
    }
     ...
     * @return ClassTypeCategorySliceCriteria
     */
    public static ClassTypeCategorySliceCriteria afterId(Long cursorId, int size) {
        return new ClassTypeCategorySliceCriteria(
                null, null, null, null, CursorPageRequest.afterId(cursorId, size));
    }

    /**
     * ClassTypeCategorySliceCriteria 생성 (static factory method)
     *
     ...
     * @return ClassTypeCategorySliceCriteria 인스턴스
     */
    public static ClassTypeCategorySliceCriteria of(
            CursorPageRequest<Long> cursorPageRequest,
            List<ClassTypeCategoryId> ids,
            List<ArchitectureId> architectureIds,
            String searchField,
            String searchWord) {
        return new ClassTypeCategorySliceCriteria(
                ids, architectureIds, searchField, searchWord, cursorPageRequest);
    }
