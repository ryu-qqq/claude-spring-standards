...
/**
 * PackageStructureQueryApiMapper - PackageStructure Query API 변환 매퍼
 *
 ...
 */
@Component
public class PackageStructureQueryApiMapper {

    /**
     * SearchPackageStructuresCursorApiRequest -> PackageStructureSearchParams 변환
     *
     ...
     * @return PackageStructureSearchParams 객체
     */
    public PackageStructureSearchParams toSearchParams(
        ...
        return PackageStructureSearchParams.of(cursorParams, request.moduleIds());
    }

    /**
     * 단일 PackageStructureResult -> PackageStructureApiResponse 변환
     *
     * <p>DTO-016: Response DTO는 String 타입으로 날짜/시간 표현.
     *
     * @param result PackageStructureResult
     * @return PackageStructureApiResponse
     */
    public PackageStructureApiResponse toResponse(PackageStructureResult result) {
    ...
    /**
     * PackageStructureResult 목록 -> PackageStructureApiResponse 목록 변환
     *
     * @param results PackageStructureResult 목록
     * @return PackageStructureApiResponse 목록
     */
    public List<PackageStructureApiResponse> toResponses(List<PackageStructureResult> results) {
        return results.stream().map(this::toResponse).toList();
    }

    /**
     * PackageStructureSliceResult -> SliceApiResponse 변환
     *
     ...
     */
    public SliceApiResponse<PackageStructureApiResponse> toSliceResponse(
            PackageStructureSliceResult sliceResult) {
        List<PackageStructureApiResponse> responses = toResponses(sliceResult.packageStructures());
        String nextCursor =
