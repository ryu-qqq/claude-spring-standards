...
/**
 * CreateArchitectureApiRequest - Architecture 생성 API Request
 *
 * <p>Architecture 생성 REST API 요청 DTO입니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "Architecture 생성 요청 DTO")
public record CreateArchitectureApiRequest(
