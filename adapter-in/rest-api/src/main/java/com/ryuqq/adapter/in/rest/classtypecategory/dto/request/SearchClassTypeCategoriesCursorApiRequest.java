...
/**
 * SearchClassTypeCategoriesCursorApiRequest - ClassTypeCategory 복합 조건 조회 API Request (커서 기반)
 *
 * <p>ClassTypeCategory 복합 조건 조회 REST API 요청 DTO입니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "ClassTypeCategory 복합 조건 조회 요청 (커서 기반)")
public record SearchClassTypeCategoriesCursorApiRequest(
