...
/**
 * CreateConventionApiRequest - Convention 생성 API Request
 *
 * <p>Convention 생성 REST API 요청 DTO입니다.
 *
 ...
 * @author ryu-qqq
 */
@Schema(description = "컨벤션 생성 요청")
public record CreateConventionApiRequest(
