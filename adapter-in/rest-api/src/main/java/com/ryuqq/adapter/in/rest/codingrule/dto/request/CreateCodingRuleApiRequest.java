...
/**
 * CreateCodingRuleApiRequest - CodingRule 생성 API Request
 *
 * <p>CodingRule 생성 REST API 요청 DTO입니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "CodingRule 생성 요청 DTO")
public record CreateCodingRuleApiRequest(
        @Schema(description = "컨벤션 ID", example = "1") @NotNull(message = "conventionId는 필수입니다")
                Long conventionId,
