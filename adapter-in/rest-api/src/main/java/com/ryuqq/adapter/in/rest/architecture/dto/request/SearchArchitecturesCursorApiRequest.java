...
/**
 * SearchArchitecturesCursorApiRequest - Architecture 복합 조건 조회 API Request (커서 기반)
 *
 * <p>Architecture 복합 조건 조회 REST API 요청 DTO입니다. TechStack ID 필터링을 지원합니다.
 *
 ...
 * @author ryu-qqq
 */
@Schema(description = "Architecture 복합 조건 조회 요청 (커서 기반)")
public record SearchArchitecturesCursorApiRequest(
