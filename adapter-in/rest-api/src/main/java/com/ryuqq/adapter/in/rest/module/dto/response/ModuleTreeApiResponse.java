...
/**
 * ModuleTreeApiResponse - Module 트리 구조 API Response
 *
 * <p>Module 트리 구조를 표현하는 REST API 응답 DTO입니다. children 필드를 통해 중첩 구조를 표현합니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "Module 트리 구조 조회 응답")
public record ModuleTreeApiResponse(
        ...
        @Schema(description = "수정 시각 (ISO 8601)", example = "2024-01-15T10:30:00Z")
                String updatedAt,
        @Schema(description = "자식 모듈 목록 (트리 구조)", example = "[]")
