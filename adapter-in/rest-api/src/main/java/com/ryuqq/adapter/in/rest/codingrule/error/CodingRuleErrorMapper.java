...
/**
 * CodingRuleErrorMapper - CodingRule 도메인 예외를 HTTP 응답으로 변환
 *
 * <p>CodingRule 관련 DomainException을 RFC 7807 호환 에러 응답으로 변환합니다.
 *
 ...
 */
@Component
public class CodingRuleErrorMapper implements ErrorMapper {

    private static final String ERROR_TYPE_BASE = "/errors/coding-rule";

    /**
     * 이 매퍼가 처리할 수 있는 예외인지 확인
     *
     * @param ex 도메인 예외
     * @return CodingRule 관련 예외이면 true
     */
    @Override
