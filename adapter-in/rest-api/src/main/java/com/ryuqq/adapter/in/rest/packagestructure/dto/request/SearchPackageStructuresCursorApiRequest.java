...
/**
 * SearchPackageStructuresCursorApiRequest - PackageStructure 복합 조건 조회 API Request (커서 기반)
 *
 * <p>PackageStructure 복합 조건 조회 REST API 요청 DTO입니다. 모듈 ID 필터링을 지원합니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "PackageStructure 복합 조건 조회 요청 (커서 기반)")
public record SearchPackageStructuresCursorApiRequest(
