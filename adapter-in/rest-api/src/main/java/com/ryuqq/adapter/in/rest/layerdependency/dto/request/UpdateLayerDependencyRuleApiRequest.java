...
/**
 * UpdateLayerDependencyRuleApiRequest - LayerDependencyRule 수정 API Request
 *
 * <p>LayerDependencyRule 수정 REST API 요청 DTO입니다.
 *
 ...
 * @since 1.0.0
 */
public record UpdateLayerDependencyRuleApiRequest(
