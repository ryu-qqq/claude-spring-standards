...
/**
 * UpdateArchUnitTestApiRequest - ArchUnitTest 수정 API Request
 *
 * <p>ArchUnitTest 수정 REST API 요청 DTO입니다.
 *
 ...
 * @since 1.0.0
 */
@Schema(description = "ArchUnitTest 수정 요청")
public record UpdateArchUnitTestApiRequest(
