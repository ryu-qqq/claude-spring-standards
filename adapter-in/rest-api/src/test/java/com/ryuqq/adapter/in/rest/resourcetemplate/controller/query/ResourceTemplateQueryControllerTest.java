...
/**
 * ResourceTemplateQueryController 통합 테스트
 *
 * <p>검증 범위:
 *
 * <ul>
...
@ActiveProfiles("test")
@DisplayName("ResourceTemplateQueryController 통합 테스트")
class ResourceTemplateQueryControllerTest {
    ...
    class SearchResourceTemplatesByCursor {
        ...
        void validRequest_ShouldReturn200() {
            // Given
            String url = ResourceTemplateApiEndpoints.RESOURCE_TEMPLATES + "?size=20";

            // When
            ResponseEntity<ApiResponse<SliceApiResponse<ResourceTemplateApiResponse>>> response =
                    restTemplate.exchange(
                            ...
                            new ParameterizedTypeReference<
                                    ApiResponse<
                                            SliceApiResponse<ResourceTemplateApiResponse>>>() {});
        ...
        void sizeOutOfRange_ShouldReturn400() {
            ...
            ResponseEntity<ApiResponse<SliceApiResponse<ResourceTemplateApiResponse>>> response =
                    restTemplate.exchange(
                            ResourceTemplateApiEndpoints.RESOURCE_TEMPLATES + "?size=101",
                            HttpMethod.GET,
                            null,
                            new ParameterizedTypeReference<
                                    ApiResponse<
