...
/**
 * ZeroToleranceRuleQueryController 통합 테스트
 *
 * <p>검증 범위:
 *
 * <ul>
...
@ActiveProfiles("test")
@DisplayName("ZeroToleranceRuleQueryController 통합 테스트")
class ZeroToleranceRuleQueryControllerTest {
    ...
    class SearchZeroToleranceRulesByCursor {
        ...
        void validRequest_ShouldReturn200() {
            // Given
            String url = ZeroToleranceRuleApiEndpoints.BASE + "?size=20";

            // When
            ResponseEntity<ApiResponse<ZeroToleranceRuleSliceApiResponse>> response =
                    restTemplate.exchange(
                            url,
                            HttpMethod.GET,
                            null,
                            new ParameterizedTypeReference<
                                    ApiResponse<ZeroToleranceRuleSliceApiResponse>>() {});
        ...
        void sizeOutOfRange_ShouldReturn400() {
            ...
            ResponseEntity<ApiResponse<ZeroToleranceRuleSliceApiResponse>> response =
                    restTemplate.exchange(
                            ZeroToleranceRuleApiEndpoints.BASE + "?size=101",
                            HttpMethod.GET,
                            null,
                            new ParameterizedTypeReference<
                                    ApiResponse<ZeroToleranceRuleSliceApiResponse>>() {});
