...
/**
 * ConventionQueryController 통합 테스트
 *
 * <p>검증 범위:
 *
 * <ul>
...
@ActiveProfiles("test")
@DisplayName("ConventionQueryController 통합 테스트")
class ConventionQueryControllerTest {
    ...
    class GetAllConventions {
        ...
        void validRequest_ShouldReturn200() {
            // Given
            String url = ConventionApiEndpoints.CONVENTIONS + "?size=20";

            // When
            ResponseEntity<ApiResponse<SliceApiResponse<ConventionApiResponse>>> response =
                    restTemplate.exchange(
                            url,
                            HttpMethod.GET,
                            null,
                            new ParameterizedTypeReference<
                                    ApiResponse<SliceApiResponse<ConventionApiResponse>>>() {});
        ...
        void sizeOutOfRange_ShouldReturn400() {
            ...
            ResponseEntity<ApiResponse<SliceApiResponse<ConventionApiResponse>>> response =
                    restTemplate.exchange(
                            ConventionApiEndpoints.CONVENTIONS + "?size=101",
                            HttpMethod.GET,
                            null,
                            new ParameterizedTypeReference<
                                    ApiResponse<SliceApiResponse<ConventionApiResponse>>>() {});
