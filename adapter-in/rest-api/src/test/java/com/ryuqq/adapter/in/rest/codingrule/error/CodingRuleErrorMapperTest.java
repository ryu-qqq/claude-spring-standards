package com.ryuqq.adapter.in.rest.codingrule.error;
 ...
 * @since 1.0.0
 */
@DisplayName("CodingRuleErrorMapper 단위 테스트")
class CodingRuleErrorMapperTest {

    private CodingRuleErrorMapper mapper;

    @BeforeEach
    void setUp() {
        mapper = new CodingRuleErrorMapper();
    }
    ...
    class Map {
        ...
        void codingRuleNotFoundException_ShouldMapTo404() {
            ...
            assertThat(mappedError.title()).isEqualTo("CodingRule Not Found");
            assertThat(mappedError.detail()).isEqualTo(ex.getMessage());
            assertThat(mappedError.type()).isEqualTo(URI.create("/errors/coding-rule/not-found"));
        }
        ...
        void unknownException_ShouldMapTo400() {
            ...
            assertThat(mappedError.title()).isEqualTo("CodingRule Error");
            assertThat(mappedError.detail()).isEqualTo(ex.getMessage());
            assertThat(mappedError.type()).isEqualTo(URI.create("/errors/coding-rule"));
        }
    }
}
