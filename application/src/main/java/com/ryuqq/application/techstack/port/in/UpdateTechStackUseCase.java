...
/**
 * UpdateTechStackUseCase - TechStack 수정 UseCase
 *
 * <p>기존 TechStack의 정보를 수정합니다.
 *
 ...
 * @author ryu-qqq
 */
public interface UpdateTechStackUseCase {

    /**
     * TechStack 수정 실행
     *
     * @param command 수정 Command
     * @throws com.ryuqq.domain.techstack.exception.TechStackNotFoundException 존재하지 않는 경우
     */
    void execute(UpdateTechStackCommand command);
}
