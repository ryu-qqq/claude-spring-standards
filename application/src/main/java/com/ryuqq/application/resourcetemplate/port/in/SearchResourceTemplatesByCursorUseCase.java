...
/**
 * SearchResourceTemplatesByCursorUseCase - ResourceTemplate 복합 조건 조회 UseCase (커서 기반)
 *
 ...
 * @author ryu-qqq
 */
public interface SearchResourceTemplatesByCursorUseCase {

    /**
     * ResourceTemplate 복합 조건 조회 실행 (커서 기반)
     *
     * @param searchParams 조회 SearchParams DTO
     * @return ResourceTemplate 슬라이스 결과
     */
    ResourceTemplateSliceResult execute(ResourceTemplateSearchParams searchParams);
}
