package com.ryuqq.application.architecture.dto.query;

import com.ryuqq.application.common.dto.query.CommonCursorParams;
import java.util.List;

/**
 * ArchitectureSearchParams - Architecture 목록 조회 SearchParams DTO
 *
 * <p>Architecture 목록을 커서 기반으로 조회하는 SearchParams DTO입니다. TechStack ID 필터링을 지원합니다.
 *
 ...
 * @author ryu-qqq
 */
public record ArchitectureSearchParams(CommonCursorParams cursorParams, List<Long> techStackIds) {

    /**
     * ArchitectureSearchParams 생성 (페이징만)
     *
     * @param cursorParams 커서 기반 페이징 파라미터
     * @return ArchitectureSearchParams 인스턴스
     */
    public static ArchitectureSearchParams of(CommonCursorParams cursorParams) {
        return new ArchitectureSearchParams(cursorParams, null);
    }

    /**
     * ArchitectureSearchParams 생성 (필터 포함)
     *
     * @param cursorParams 커서 기반 페이징 파라미터
     * @param techStackIds TechStack ID 필터 목록
     * @return ArchitectureSearchParams 인스턴스
     */
    public static ArchitectureSearchParams of(
            CommonCursorParams cursorParams, List<Long> techStackIds) {
        return new ArchitectureSearchParams(cursorParams, techStackIds);
    }
