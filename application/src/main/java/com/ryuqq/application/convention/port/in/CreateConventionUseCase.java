...
/**
 * CreateConventionUseCase - Convention 생성 UseCase
 *
 * <p>새로운 Convention을 생성합니다.
 *
 ...
 * @author ryu-qqq
 */
public interface CreateConventionUseCase {
     ...
     */
    Long execute(CreateConventionCommand command);
}
