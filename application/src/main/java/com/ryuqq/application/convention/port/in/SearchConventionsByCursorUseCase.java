...
/**
 * SearchConventionsByCursorUseCase - Convention 복합 조건 조회 UseCase (커서 기반)
 *
 ...
 * @author ryu-qqq
 */
public interface SearchConventionsByCursorUseCase {

    /**
     * Convention 복합 조건 조회 실행 (커서 기반)
     *
     * @param searchParams 조회 SearchParams DTO
     * @return Convention 슬라이스 결과
     */
    ConventionSliceResult execute(ConventionSearchParams searchParams);
}
