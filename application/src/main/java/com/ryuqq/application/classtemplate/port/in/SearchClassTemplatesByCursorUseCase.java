...
/**
 * SearchClassTemplatesByCursorUseCase - ClassTemplate 복합 조건 조회 UseCase (커서 기반)
 *
 ...
 * @author ryu-qqq
 */
public interface SearchClassTemplatesByCursorUseCase {

    /**
     * ClassTemplate 복합 조건 조회 실행 (커서 기반)
     *
     * @param searchParams 조회 SearchParams DTO
     * @return ClassTemplate 슬라이스 결과
     */
    ClassTemplateSliceResult execute(ClassTemplateSearchParams searchParams);
}
